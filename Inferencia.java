public class Inferencia {
	public static void main(String[] args){
		...
		/*
			É uma interpretação baseada em fatos, indícios e conhecimento prévio, permitindo entender intenções implícitas em textos ou situações,
			funcionando como uma ponte entre o que foi dito e o que se conclui.
